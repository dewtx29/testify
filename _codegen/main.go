...
var (
	pkg       = flag.String("assert-path", "github.com/lumiluminousai/testify/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/lumiluminousai/testify/_codegen; DO NOT EDIT.
